...
const ProfilePage = () => {
  ...
  const [isHoveringBasicInfo, setIsHoveringBasicInfo] = useState(false);
    ...
    <div className={styles.pageWrapper}>
      ...
      <div className={styles.profileContainer}>
        ...
        <div className={styles.profileSection} 
             onMouseEnter={() => setIsHoveringBasicInfo(true)}
             onMouseLeave={() => setIsHoveringBasicInfo(false)}>
          <div className={styles.sectionHeader}>
            <h2 className={styles.sectionTitle}>Informations de base</h2>
            {isHoveringBasicInfo && (
              <button className={styles.editSectionButton} onClick={handleOpenBasicInfoEdit}>
  ...
  <div className={styles.formRow}>
    <div className={styles.formGroup}>
      ...
      <input
        type="text"
        value={updatedUserData.prenom}
        onChange={(e) => setUpdatedUserData({...updatedUserData, prenom: e.target.value})}
      />
    </div>
    <div className={styles.formGroup}>
      <label>Nom</label>
      <input
        ...
        onChange={(e) => setUpdatedUserData({...updatedUserData, nom: e.target.value})}
      />
    </div>
  </div>
                <div className={styles.formGroup}>
                  ...
                  <input
                    type="text"
                    value={updatedUserData.telephone}
                    onChange={(e) => setUpdatedUserData({...updatedUserData, telephone: e.target.value})}
                  />
                </div>
                <div className={styles.formGroup}>
                  <label>Adresse</label>
                  <input
                    ...
                    onChange={(e) => setUpdatedUserData({...updatedUserData, adresse: e.target.value})}
                  />
                </div>
...
{selectedReview && (
  ...
  <div className={styles.modalOverlay} onClick={() => { setShowCvModal(false); setPdfPreviewUrl(""); }}>
    <div className={`${styles.modalContent} ${styles.cvModalContent}`} onClick={(e) => e.stopPropagation()}>
      ...
      <button className={styles.modalCloseBtn} onClick={() => { setShowCvModal(false); setPdfPreviewUrl(""); }}>
        ...
        {showAddCompetenceModal && (
          <div className={styles.modalOverlay} onClick={closeAddCompetenceModal}>
            <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
              ...
              <form className={styles.form} onSubmit={handleAddCompetenceSubmit}>
                <div className={styles.formGroup}>
        ...
        {showAddDomaineModal && (
          <div className={styles.modalOverlay} onClick={closeAddDomaineModal}>
            <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
              <button className={styles.modalCloseBtn} onClick={closeAddDomaineModal}>&times;</button>
              <h2>Ajouter un domaine</h2>
              <form className={styles.form} onSubmit={handleAddDomaineSubmit}>
                <div className={styles.formGroup}>
        ...
        {showAddLangueModal && (
          <div className={styles.modalOverlay} onClick={closeAddLangueModal}>
            <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
              <button className={styles.modalCloseBtn} onClick={closeAddLangueModal}>&times;</button>
              <h2>Ajouter une langue</h2>
              <form className={styles.form} onSubmit={handleAddLangueSubmit}>
                <div className={styles.formGroup}>
        ...
        {showAddFormationModal && (
          <div className={styles.modalOverlay} onClick={closeAddFormationModal}>
            <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
              <button className={styles.modalCloseBtn} onClick={closeAddFormationModal}>&times;</button>
              <h2>Ajouter une formation</h2>
              <form className={styles.form} onSubmit={handleAddFormationSubmit}>
                <div className={styles.formGroup}>
                  <label>Diplôme</label>
                  <input className={styles.modalInput}
                    type="text"
        ...
        {showAddCertificationModal && (
          <div className={styles.modalOverlay} onClick={closeAddCertificationModal}>
            <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
              <button className={styles.modalCloseBtn} onClick={closeAddCertificationModal}>&times;</button>
              <h2>Ajouter une certification</h2>
              <form className={styles.form} onSubmit={handleAddCertificationSubmit}>
                <div className={styles.formGroup}>
